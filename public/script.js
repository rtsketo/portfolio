...
const tagMap = {
  "Shared Android platform": ["Android", "Kotlin", "API", "Loyalty"],
  "Smart API/cache layer": ["Android", "Kotlin", "Cache", "API"],
  "Image loading and disk cache": ["Android", "Kotlin", "Images", "Cache"],
  ...
  Surprize: ["Android", "Kotlin", "Loyalty"],
  ...
  "Azure mobile release templates": ["CI/CD", "Azure", "DevOps"],
  "Custom Gradle build tooling": ["Gradle", "Android", "CI/CD"],
  "PR review automation": ["AI", "Azure", "DevOps"],
  "Dockerized agent infrastructure": ["Docker", "Azure", "DevOps"],
  "Support libraries": ["Kotlin", "Security", "Cache"],
  ".NET API/library pipeline support": [".NET", "API", "CI/CD"],
  "Custom agent workflow system": ["AI", "DevOps", "Automation"],
  ...
  "Bottom Sheet Image Picker": ["Android", "Kotlin", "Library"],
  CountryCodePicker: ["Android", "Java", "Library"],
  LoadingButtonAndroid: ["Android", "Kotlin", "Library"],
  "Pdf-Viewer": ["Android", "Kotlin", "Library"],
  RoundableLayout: ["Android", "Kotlin", "Library"],
  "Wikimedia Commons app": ["Android", "Java"],
  Flashbar: ["Android", "Kotlin", "Library"],
  "BlurKit Android": ["Android", "Java", "Library"],
  ElevationImageView: ["Android", "Kotlin", "Library"],
};
